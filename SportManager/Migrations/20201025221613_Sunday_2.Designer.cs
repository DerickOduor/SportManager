...
namespace SportManager.Migrations
{
    ...
    [Migration("20201025221613_Sunday_2")]
    partial class Sunday_2
    {
            ...
            modelBuilder.Entity("SportManager.Models.SportDiscipine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("910ce653-c7f1-4429-9b95-19270767129d"),
                            DateAdded = new DateTime(2020, 10, 26, 1, 16, 12, 255, DateTimeKind.Local).AddTicks(2420),
                            Deleted = false,
                            Name = "Football",
                            Status = true
                        });
            ...
            modelBuilder.Entity("SportManager.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateRegistered = new DateTime(2020, 10, 26, 1, 16, 12, 253, DateTimeKind.Local).AddTicks(731),
                            Deleted = false,
                        ...
                        new
                        {
                            ...
                            Authorized = true,
                            ChangePassword = false,
                            DateRegistered = new DateTime(2020, 10, 26, 1, 16, 12, 254, DateTimeKind.Local).AddTicks(9838),
                            Deleted = false,
            ...
            modelBuilder.Entity("SportManager.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Authorized = true,
                            ChangePassword = false,
                            DateRegistered = new DateTime(2020, 10, 26, 1, 16, 12, 255, DateTimeKind.Local).AddTicks(9370),
