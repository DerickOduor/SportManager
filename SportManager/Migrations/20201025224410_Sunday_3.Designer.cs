...
namespace SportManager.Migrations
{
    ...
    [Migration("20201025224410_Sunday_3")]
    partial class Sunday_3
    {
            ...
            modelBuilder.Entity("SportManager.Models.SportDiscipine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("910ce653-c7f1-4429-9b95-19270767129d"),
                            DateAdded = new DateTime(2020, 10, 26, 1, 44, 9, 513, DateTimeKind.Local).AddTicks(9704),
                            Deleted = false,
                            Name = "Football",
                            Status = true
                        });
            ...
            modelBuilder.Entity("SportManager.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateRegistered = new DateTime(2020, 10, 26, 1, 44, 9, 510, DateTimeKind.Local).AddTicks(4761),
                            Deleted = false,
                        ...
                        new
                        {
                            ...
                            Authorized = true,
                            ChangePassword = false,
                            DateRegistered = new DateTime(2020, 10, 26, 1, 44, 9, 513, DateTimeKind.Local).AddTicks(5757),
                            Deleted = false,
            ...
            modelBuilder.Entity("SportManager.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Authorized = true,
                            ChangePassword = false,
                            DateRegistered = new DateTime(2020, 10, 26, 1, 44, 9, 515, DateTimeKind.Local).AddTicks(760),
