...
namespace SportManager.Migrations
{
    ...
    [Migration("20201102195820_Monday_02112020")]
    partial class Monday_02112020
    {
            ...
            modelBuilder.Entity("SportManager.Models.SportDiscipine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("910ce653-c7f1-4429-9b95-19270767129d"),
                            DateAdded = new DateTime(2020, 11, 2, 22, 58, 19, 352, DateTimeKind.Local).AddTicks(4871),
                            Deleted = false,
                            Name = "Football",
                            Status = true
                        });
            ...
            modelBuilder.Entity("SportManager.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateRegistered = new DateTime(2020, 11, 2, 22, 58, 19, 350, DateTimeKind.Local).AddTicks(2983),
                            Deleted = false,
                        ...
                        new
                        {
                            ...
                            Authorized = true,
                            ChangePassword = false,
                            DateRegistered = new DateTime(2020, 11, 2, 22, 58, 19, 352, DateTimeKind.Local).AddTicks(1306),
                            Deleted = false,
            ...
            modelBuilder.Entity("SportManager.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Authorized = true,
                            ChangePassword = false,
                            DateRegistered = new DateTime(2020, 11, 2, 22, 58, 19, 353, DateTimeKind.Local).AddTicks(6101),
