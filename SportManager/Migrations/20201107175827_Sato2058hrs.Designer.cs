...
namespace SportManager.Migrations
{
    ...
    [Migration("20201107175827_Sato2058hrs")]
    partial class Sato2058hrs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportManager.Models.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("96deb675-0d05-47e8-9827-3fbd3b6be7a8"),
                            Level = 1,
                            Link = "/Store/",
                            MenuType = "SUB-MENU",
                            MenuUser = "STAFF",
                        ...
                        new
                        {
                            Id = new Guid("a4f70713-403c-449d-b60f-20cee0087f55"),
                            Level = 1,
                            Link = "/Event/",
                            MenuType = "SUB-MENU",
                            MenuUser = "STAFF",
                        ...
                        new
                        {
                            Id = new Guid("3a0672c3-5af1-416f-a09c-ae3143fe31c2"),
                            Level = 2,
                            Link = "/Event/Create/",
                            MenuType = "SUB-MENU",
                            MenuUser = "STAFF",
                        ...
                        new
                        {
                            Id = new Guid("ebc9b700-2cd3-4984-811c-01dd30c6beb6"),
                            Level = 2,
                            Link = "/Venue/",
                            MenuType = "SUB-MENU",
                            MenuUser = "STAFF",
                        ...
                        new
                        {
                            Id = new Guid("8d3d14a1-0209-49e4-bbbf-b3a79f7381b6"),
                            Level = 2,
                            Link = "/Venue/",
                            MenuType = "SUB-MENU",
                            MenuUser = "STAFF",
            ...
            modelBuilder.Entity("SportManager.Models.SportDiscipinePatron", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SportDiscipinePatrons");
                });
            ...
            modelBuilder.Entity("SportManager.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Password = "GTbfZW0odYQ9g2uyGrB+Rw==",
                            Phone = "+254712345678",
                            ProfileId = new Guid("bfdedc6a-01d1-44f7-9e70-595b8091342a"),
                        ...
                        new
                        {
                            ...
                            Password = "GTbfZW0odYQ9g2uyGrB+Rw==",
                            Phone = "+254712345678",
                            ProfileId = new Guid("cb8f202b-549b-448d-a2e8-927ff944813e"),
            ...
            modelBuilder.Entity("SportManager.Models.SportDiscipinePatron", b =>
                {
                    b.HasOne("SportManager.Models.SportDiscipine", "SportDiscipine")
                        .WithOne("SportDiscipinePatron")
                        .HasForeignKey("SportManager.Models.SportDiscipinePatron", "SportDiscipineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportManager.Models.Staff", "Staff")
                        .WithOne("SportDiscipinePatron")
                        .HasForeignKey("SportManager.Models.SportDiscipinePatron", "StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SportManager.Models.SportDisciplinesInEvent", b =>
                {
                    b.HasOne("SportManager.Models.Event", "Event")
                        .WithMany("SportDisciplinesInEvent")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
