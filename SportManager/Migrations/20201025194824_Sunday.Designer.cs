...
namespace SportManager.Migrations
{
    ...
    [Migration("20201025194824_Sunday")]
            ...
            modelBuilder.Entity("SportManager.Models.SportDiscipine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateAdded = new DateTime(2020, 10, 25, 22, 48, 24, 84, DateTimeKind.Local).AddTicks(676),
                            Deleted = false,
                            Name = "Football",
                            Status = true
                        });
            ...
            modelBuilder.Entity("SportManager.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("327d571a-1690-44e0-806d-65e0593364ad"),
                            Authorized = true,
                            DateRegistered = new DateTime(2020, 10, 25, 22, 48, 24, 81, DateTimeKind.Local).AddTicks(1574),
                            Deleted = false,
                        ...
                        new
                        {
                            ...
                            Authorized = true,
                            DateRegistered = new DateTime(2020, 10, 25, 22, 48, 24, 83, DateTimeKind.Local).AddTicks(7295),
                            Deleted = false,
            ...
            modelBuilder.Entity("SportManager.Models.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("910ce653-c7f1-4429-9b95-19270767129d"),
                            Authorized = true,
                            DateRegistered = new DateTime(2020, 10, 25, 22, 48, 24, 85, DateTimeKind.Local).AddTicks(11),
