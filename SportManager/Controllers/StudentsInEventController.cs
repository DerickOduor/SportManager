                        ...
                        try
                        {
                            ...
                            if (students != null)
                            {
                                if (students.Count > 0)
                                {
                                    ...
                                    table.AddCell(createCell("Discipine", (float)0.5, 1, TextAlignment.LEFT));

                                    foreach (StudentsParticipatingInEvent student in students)
                                    {
                                        table.AddCell(createCell(student.Student.Firstname+" "+student.Student.Lastname, (float)0.5, 1, TextAlignment.LEFT));
                                        table.AddCell(createCell(student.Student.RegistrationNumber, (float)0.5, 1, TextAlignment.LEFT));
