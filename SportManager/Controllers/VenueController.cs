                        ...
                        try
                        {
                            ...
                            if (students != null)
                            {
                                if (students.Count > 0)
                                {
                                    ...
                                    table.AddCell(createCell("Location", (float)0.5, 1, TextAlignment.LEFT));
                                    table.AddCell(createCell("Capacity", (float)0.5, 1, TextAlignment.LEFT));
                                    table.AddCell(createCell("Available", (float)0.5, 1, TextAlignment.LEFT));

                                    foreach (Venue student in students)
                                    {
                                        table.AddCell(createCell(student.Name, (float)0.5, 1, TextAlignment.LEFT));
                                        table.AddCell(createCell(student.Location, (float)0.5, 1, TextAlignment.LEFT));
                                        table.AddCell(createCell(student.Capacity+"", (float)0.5, 1, TextAlignment.LEFT));
                                        table.AddCell(createCell(student.Available?"Yes":"No", (float)0.5, 1, TextAlignment.LEFT));
                                    }
