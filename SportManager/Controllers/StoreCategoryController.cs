                        ...
                        try
                        {
                            ...
                            if (students != null)
                            {
                                if (students.Count > 0)
                                {
                                    ...
                                    table.AddCell(createCell("Quantity", (float)0.5, 1, TextAlignment.LEFT));
                                    table.AddCell(createCell("Category", (float)0.5, 1, TextAlignment.LEFT));
                                    ...
                                    foreach (StoreItem student in students)
                                    {
                                        ...
                                        table.AddCell(createCell(student.Count+"", (float)0.5, 1, TextAlignment.LEFT));
                                        table.AddCell(createCell(student.StoreCategory.Name, (float)0.5, 1, TextAlignment.LEFT));
                                    }
